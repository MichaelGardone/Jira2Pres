...
public class IssueConnection extends Connection {

	public IssueConnection(String url, String user, String pass) {
		super(url, user, pass);
	}
	...
	public String connect(int id, int sprintId) {
		...
		target = client.target(curls.getIssues(url, id, sprintId));
		...
		try {
			...
			return "This sprint does not exist; please us a different one.";
